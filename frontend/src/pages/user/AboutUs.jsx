    ...
    <div className="about-page">
      ...
      <section className="about-hero-section">
        <div className="about-container">
          <h1 className="about-hero-title">About Our Utkarsh Library</h1>
          ...
          <div className="about-mission-content">
            <div className="about-mission-text">
              ...
              <p className="about-mission-paragraph">
                The Utkarsh Library is committed to empowering the academic and research pursuits of students and faculty. Our mission is to ensure equitable access to diverse information resources, promote information literacy, and cultivate an environment that fosters learning, critical thinking, and intellectual growth. By integrating innovative services and a student-centered approach, the library serves as a cornerstone for knowledge creation and scholarly excellence.
              </p>
              <p className="about-mission-paragraph">
          ...
          <div className="about-timeline">
            <div className="about-timeline-item">
              ...
              <div className="about-timeline-content">
                ...
                <p className="about-timeline-description">The Utkarsh library was established with a modest collection of 2,000 books to serve the newly founded institution.</p>
              </div>
            </div>
            <div className="about-timeline-item">
      ...
      <section className="about-cta-section">
        <div className="about-container">
          ...
          <div className="about-cta-buttons">
            <Link to="https://www.google.com/maps/place/GITM%28Goel+Institute+Of+Technology+And+Management%29/data=!4m7!3m6!1s0x39995f565439ba35:0x3a8b24c8c1c10760!8m2!3d26.8943577!4d81.0826608!16s%2Fg%2F11dyq_y0wx!19sChIJNbo5VFZfmTkRYAfBwcgkizo?authuser=0&hl=en&rclk=1" target='_blank' className="about-btn about-btn-primary">
              <FiMapPin className="about-icon" /> Visit Us
            </Link>
            <Link to="https://www.google.com/search?q=goel+institute+services+inc&sca_esv=7f3e28514a708fd9&sxsrf=ANbL-n45qTrOZPkhxCtcqVZsZBBQhb-0YQ%3A1768458648015&ei=mIloaZFTxa2x4w_tgs-BBg&ved=0ahUKEwiR_47s9YySAxXFVmwGHW3BM2AQ4dUDCBE&uact=5&oq=goel+institute+services+inc&gs_lp=Egxnd3Mtd2l6LXNlcnAiG2dvZWwgaW5zdGl0dXRlIHNlcnZpY2VzIGluYzIIEAAYgAQYogQyCBAAGIAEGKIEMggQABiABBiiBDIIEAAYgAQYogRI0kJQpAZYxytwAXgCkAEAmAGNA6ABvxWqAQcwLjMuNi4yuAEDyAEA-AEBmAIHoAKCC8ICBBAAGEfCAggQIRigARjDBMICChAAGEcY1gQYsAPCAgoQIRgKGKABGMMEmAMAiAYBkAYIkgcHMi4xLjIuMqAHriOyBwcwLjEuMi4yuAeoCsIHBzItMS4zLjPIB44BgAgB&sclient=gws-wiz-serp" target='_blank' className="about-btn about-btn-secondary">
              Our Services
            </Link>
          </div>
        </div>
